...
const Viewpage2Icon = () => {
  ...
  return (
    ...
    >
      <Image
        style={styles.fa4e37d84b131Icon}
        resizeMode="cover"
        source={require("../assets/5fa4e37d84b13-1.png")}
      />
      <Image
      ...
      />
      <Text style={styles.tamanNasionalKomodoContainer}>
        <Text style={styles.tamanNasional}>{`Taman Nasional `}</Text>
        <Text style={styles.komodo}>Komodo</Text>
      </Text>
      <Image
